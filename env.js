var sysConfig = {
  baseUrl: 'https://wap1.hispace.hicloud.com',
  domainUrl: 'https://appgallery1.huawei.com/',
  queryTimeout: 80000,
  serviceType: 20,
  pageSize: 15,
  externalLink: {
    ...
    harmonyPrivacyPolicy: 'https://legal.cloud.huawei.com/terms/scope/huawei/appgallery/privacy-statement.htm',
    aboutCookie: 'https://consumer.huawei.com/cn/legal/cookie-policy/',
    beian: 'http://beian.miit.gov.cn/state/outPortal/loginPortal.action',
    appTestPrivacyPolicy: 'https://legal.cloud.huawei.com.cn/terms/scope/huawei/app-test-hmos/privacy-statement.htm'
  },
  showRecommendAlgorithm: false,
  appIdOfAppGallery: "C27162",
  maxResults: 25,
  isOversea: false,
  validDomains:["https://appgallery5.huawei.com", "https://appgallery7.huawei.com", "https://appgallery8.huawei.com"],
  basePicture: 'this.style.background="#f2f2f2"',
  site: 'cn',
  mwIndexUrl: 'https://appgallery.cloud.huawei.com/uowap/index.html',
  ...
  webEdge: {
    ...
    "baseUrl_singapore": 'https://web-dra.hispace.dbankcloud.com/edge',
  ...
  resource: {
    fastAppScriptUrl: 'https://statres.quickapp.cn/quickapp/js/routerinline.min.js'
  },
    hasdk: {
      reportUrl: 'https://metrics-drcn.dt.hicloud.com:443/webv1',
  ...
  xssProtectSwitch: 'on',
  mapOfBranchId: {'appgallery':{'userContract':{'cn':'1','sg':'1','de':'0'},'privacy':{'cn':'2','sg':'2','de':'1'}},'gamecenter':{'userContract':{'cn':'1','sg':'1','de':'0'},'privacy':{'cn':'1','sg':'2','de':'1'}},'apptest':{'userContract':{'cn':'1','sg':'1','de':'0'},'privacy':{'cn':'0'}}},
  ...
  useNewApiCommenList3: true,
  tabInfoMarginBottom: '0px',
  cookieVersion: 'V20250116',
  antiVirusUrl: 'https://www.anva.org.cn/html/alliance/appstore',
  harmonyPageDetailPrefix: 'webAgAppDetail',
  harmonyPageDetailPkgPrefix: 'webAgPackage',
  harmonyPrivacyIntroPrefix: 'webAgPrivacyIntro',
  harmonyPrivacyDataCollectPrefix: 'webAgAppPrivacyDataCollect',
  harmonyPageOrderPrefix: 'webAgAppOrder',
  harmonySubstanceDetailPrefix: 'webAgSubstanceDetail',
  harmonyAppDetail: 'https://appgallery.huawei.com/app/detail',
  harmonyClientPackage: 'com.huawei.hmsapp.appgallery',
  harmonyAccountZone: 'CN'
};
